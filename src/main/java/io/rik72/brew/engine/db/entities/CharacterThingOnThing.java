...
@Entity
public class CharacterThingOnThing implements AbstractEntity, ConsequenceOnThing {
	...
	public CharacterThingOnThing() {
	}

	public CharacterThingOnThing(String action,
