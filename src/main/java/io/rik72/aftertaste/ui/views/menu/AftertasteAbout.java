...
public class AftertasteAbout extends MenuItem {
	public AftertasteAbout(String text) {
		...
		setOnAction(e -> {
			...
			versionText.setFont(CurrentSkin.getGUIFont());
			...
			t1.setFont(CurrentSkin.getGUIFont());
			Hyperlink licenseHL = new Hyperlink("GPL-3.0 license");
			licenseHL.setFont(CurrentSkin.getGUIFont());
			...
			t4.setFont(CurrentSkin.getGUIFont());
			...
			t5.setFont(CurrentSkin.getGUIFont());
			Hyperlink attribHL = new Hyperlink("see it on Freepik");
			attribHL.setFont(CurrentSkin.getGUIFont());
